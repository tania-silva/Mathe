...
$catalogue = new MessageCatalogue('en', array (
  'messages' => 
  array (
    'davis-customheader.admin.settings.title' => 'Custom Header Configuration',
    'davis-customheader.admin.settings.customheader' => 'Custom Header HTML',
    'davis-customheader.admin.settings.jsofheader' => 'Custom Header Javascript',
    'davis-customheader.admin.settings.cssofheader' => 'Custom Header CSS',
...
',
    ...
    'the-turk-mathren.admin.settings.title' => 'MathRen',
    'the-turk-mathren.admin.settings.description' => 'Configure TeX math rendering.',
    'the-turk-mathren.admin.settings.wrapperOptionsHeading' => 'Wrapper Options',
    'the-turk-mathren.admin.settings.mathClasses' => 'Class names for the <code>span</code> tag',
    'the-turk-mathren.admin.settings.mathClassesHelp' => 'You can easily stylize your <code>span</code> wrappers using class names.',
    'the-turk-mathren.admin.settings.blockMathClass' => 'The <code>span</code> tag for block expressions',
    'the-turk-mathren.admin.settings.inlineMathClass' => 'The <code>span</code> tag for inline expressions',
    'the-turk-mathren.admin.settings.wrapperStyle' => 'Stylize <code>span</code> wrappers',
    'the-turk-mathren.admin.settings.katexOptionsHeading' => 'KaTeX Options',
    'the-turk-mathren.admin.settings.enableFleqn' => 'Enable flush left equations (fleqn)',
    'the-turk-mathren.admin.settings.enableLeqno' => 'Enable left equation numbers (leqno)',
    'the-turk-mathren.admin.settings.delimiters' => 'Delimiters',
    'the-turk-mathren.admin.settings.delimitersHelp' => 'Separate them with commas. <strong>%e%</strong> stands for mathematical expression.',
    'the-turk-mathren.admin.settings.mainBlockDelimiter' => 'Main <strong>BBCode</strong> delimiter for block expressions',
    'the-turk-mathren.admin.settings.mainInlineDelimiter' => 'Main <strong>BBCode</strong> delimiter for inline expressions',
    'the-turk-mathren.admin.settings.aliasBlockDelimiters' => 'Alias delimiters for block expressions',
    'the-turk-mathren.admin.settings.aliasInlineDelimiters' => 'Alias delimiters for inline expressions',
    'the-turk-mathren.admin.settings.aliasDelimitersHelp' => 'They meant to be <strong>alias</strong> for <em>main BBCode delimiters</em>. If you have special delimiters (like <code>$$</code>) in your alias delimiters list, MathRen will scan the whole post for these additional delimiters when saving a post and will try to replace them with main BBCode delimiters. This may cause longer waiting time when saving a post. You may want to use additional BBCode delimiters instead of special ones to prevent this action though.',
    'the-turk-mathren.admin.settings.ignoringExpressions' => 'Ignoring Expressions',
    'the-turk-mathren.admin.settings.ignoringExpressionsHelp' => 'Separate them with commas.',
    'the-turk-mathren.admin.settings.decisiveKeywords' => 'List of decisive keywords to ignore expressions',
    'the-turk-mathren.admin.settings.decisiveKeywordsHelp' => 'You will write one of these decisive keywords next to the <em>special</em> right delimiter (other than BBCode) with curly brackets (i.e. <code>$$%e%$${<strong>keyword</strong>}</code>) or inside a BBCode (i.e. <code>[math=<strong>keyword</strong>]%e%[/math]</code>) to prevent expressions from rendering. <strong>Note that</strong> <code>[math]%e%[/math]{<strong>keyword</strong>}</code> is an example of <u>invalid usage</u>.',
    'the-turk-mathren.admin.settings.decisiveKeywordsInfo' => 'First keyword in this list will be used as default by text editor.',
    'the-turk-mathren.admin.settings.decisiveKeywordsWarning' => 'Do not use special characters! Or it will throw an exception.',
    'the-turk-mathren.admin.settings.ignoredTags' => 'List of DOM node types to ignore when recursing through',
    'the-turk-mathren.admin.settings.ignoredClasses' => 'List of DOM node class names to ignore when recursing through',
    'the-turk-mathren.admin.settings.ignoredClassesInfo' => 'First class in this list will be used as default to wrap ignored expression with.',
    'the-turk-mathren.admin.settings.outputMode' => 'Output mode',
    'the-turk-mathren.admin.settings.outputModeHelp' => 'Choose the markup language for the output',
    'the-turk-mathren.admin.settings.enableColorIsTextColor' => 'Allow <code>\\color</code> command to take two arguments (colorIsTextColor)',
    'the-turk-mathren.admin.settings.enableThrowOnError' => 'Throw an error on unsupported command or invalid LaTeX',
    'the-turk-mathren.admin.settings.errorColor' => 'Color of unsupported commands or invalid LaTeX',
    'the-turk-mathren.admin.settings.errorColorHelp' => 'Choose the color that unsupported commands and invalid LaTeX are rendered in when error throwing is disabled.',
    'the-turk-mathren.admin.settings.sizeSettings' => 'Sizing options',
    'the-turk-mathren.admin.settings.sizeSettingsHelp' => 'Use <strong>point</strong> as decimal seperator. <em>Infinite values</em> are not acceptable!',
    'the-turk-mathren.admin.settings.minRuleThickness' => 'Minimum thickness (em)',
    'the-turk-mathren.admin.settings.maxSize' => 'Maximum size (em)',
    'the-turk-mathren.admin.settings.macros' => 'Macros',
    'the-turk-mathren.admin.settings.macrosHelp' => 'A collection of custom macros.',
    'the-turk-mathren.admin.settings.maxExpand' => 'Maximum expand limit',
    'the-turk-mathren.admin.settings.katexOptionsInfo' => 'You can find more information for KaTeX options on https://katex.org/',
    'the-turk-mathren.admin.settings.otherOptionsHeading' => 'Other Options',
    'the-turk-mathren.admin.settings.enableTextEditorButtons' => 'Show buttons on text editor',
    'the-turk-mathren.forum.textEditor.blockExpression' => 'Block Expression',
    'the-turk-mathren.forum.textEditor.inlineExpression' => 'Inline Expression',
    'flagrow-analytics.admin.popup.title' => 'Analytics Settings',
    'flagrow-analytics.admin.popup.section.googleAnalytics' => 'Google Analytics',
    'flagrow-analytics.admin.popup.section.piwik' => 'Piwik',
    'flagrow-analytics.admin.popup.field.statusGoogle' => 'Enable Google Analytics',
    'flagrow-analytics.admin.popup.field.googleTrackingCode' => 'Tracking Code ID',
    'flagrow-analytics.admin.popup.field.statusPiwik' => 'Enable Piwik',
    'flagrow-analytics.admin.popup.field.piwikUrl' => 'Piwik domain or url',
    'flagrow-analytics.admin.popup.field.piwikSiteId' => 'Site ID',
    'flagrow-analytics.admin.popup.field.piwikTrackSubdomain' => 'Track visitors across all subdomains of Flarum',
    'flagrow-analytics.admin.popup.field.piwikPrependDomain' => 'Prepend the site domain to the page title when tracking',
    'flagrow-analytics.admin.popup.field.piwikHideAliasUrl' => 'In the "Outlinks" report, hide clicks to known alias URLs',
    'flagrow-analytics.admin.popup.field.piwikAliasUrl' => 'Alias Url',
    'flagrow-analytics.admin.popup.field.piwikTrackAccounts' => 'Track individual user accounts',
    'flagrow-analytics.admin.popup.field.piwikAuthToken' => 'Authentication Token',
    'flagrow-analytics.admin.popup.placeholder.piwikAuthToken' => 'Fill this token to enable a Piwik stats tab in the admin panel.
You can find it in Settings > Personal > API Authentication Token.
',
    'flagrow-analytics.admin.popup.trackAccounts.none' => 'Do not track',
    'flagrow-analytics.admin.popup.trackAccounts.username' => 'Track by username',
    'flagrow-analytics.admin.popup.trackAccounts.email' => 'Track by email',
    'flagrow-analytics.admin.page.nav.title' => 'Analytics',
    'flagrow-analytics.admin.page.nav.description' => 'Take a look at Statistics',
    'dem13n.forum.nickname.head_title' => 'Nickname',
    'dem13n.forum.nickname.new_nickname' => 'Enter a new nickname',
    'dem13n.forum.nickname.change' => 'Change Nickname',
    'dem13n.forum.nickname.submit_button' => '=> core.ref.save_changes',
    'dem13n.admin.nickname.settings_modal_title' => 'Settings Nickname Changer',
    'dem13n.admin.nickname.unlimited_nickname_change' => 'Unlimited nickname change',
    'dem13n.admin.nickname.allow_nickname_change' => 'Allow nickname change',
    'dem13n.admin.nickname.allow_nickname_unique' => 'Allow same nicknames',
    'dem13n.admin.nickname.regex' => 'Regular expression for validation',
    'dem13n.admin.nickname.min_char' => 'Minimum characters in a nickname',
    'dem13n.admin.nickname.max_char' => 'Maximum characters in a nickname',
    'dem13n.admin.nickname.submit_button' => '=> core.ref.save_changes',
    'the-turk-password-strength.admin.settings.title' => 'Password Strength Indicator Settings',
    'the-turk-password-strength.admin.settings.enableLabel' => 'Show the strength label',
    'the-turk-password-strength.admin.settings.displayMode' => 'Choose a display mode',
    'the-turk-password-strength.admin.settings.enableInputColor' => 'Change input\'s foreground color with password strength score',
    'the-turk-password-strength.admin.settings.enableInputBackground' => 'Change input\'s background color with password strength score',
    'the-turk-password-strength.admin.settings.noInputColor' => 'Don\'t change input\'s colors',
    'the-turk-password-strength.admin.settings.colorOptions' => 'Color Options',
    'the-turk-password-strength.admin.settings.weakColor' => 'Color of the weak password',
    'the-turk-password-strength.admin.settings.strongColor' => 'Color of the strong password',
    'the-turk-password-strength.admin.settings.foreColor' => 'Foreground color of the password input element',
    'the-turk-password-strength.admin.settings.colorHelp' => 'Use RGB (Red, Green, Blue) values as R,G,B',
    'the-turk-password-strength.forum.strengthLabels.veryWeak' => 'Very weak',
    'the-turk-password-strength.forum.strengthLabels.weak' => 'Weak',
    'the-turk-password-strength.forum.strengthLabels.average' => 'Average',
    'the-turk-password-strength.forum.strengthLabels.strong' => 'Strong',
    'the-turk-password-strength.forum.strengthLabels.veryStrong' => 'Very strong',
...
',
    ...
    'maicol07-sso.admin.settings.disable_login_btn' => 'Disable login button',
    'maicol07-sso.admin.settings.disable_signup_btn' => 'Disable signup button',
  ),
));
