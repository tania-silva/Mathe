...
if ($from=="toggle") $destPage="MP_LECT_SNA_videoRevApprovedList";
else $destPage="MP_LECT_SNA_videoRevValidateList";
...
?>
	...
	<script src='https://cdnjs.cloudflare.com/ajax/libs/mathjax/2.7.5/latest.js?config=TeX-MML-AM_CHTML' async></script>
					...
					<form method="post" action="./MP_LECT_SNA_videoRevValidateResponse.php?act=reg&id_act=<?=$vidId?>&<?=$queryStr?>" enctype="multipart/form-data" style="display: block;margin-top: 5px;padding: 20px 0 20px 50px;border: solid 1px #00aeef;border-radius: 10px;">
						...
						<div class="signup_field_ext">
							<div style="width: 625px;padding: 10px 0 10px 10px;border: dotted 1px #666;border-radius: 5px;">
								<div style="float: left;width: 300px;">
									<p><span style="font-weight: 400;color: #666;">Code:</span> VRE<?=$vidId?></p>
								...
								<div style="float: right;width: 300px;margin-right: 10px;border: solid 1px #ccc;border-radius: 5px;">
									...
									<div style="padding: 5px;">
										...
										<p><a href="mailto:<?=$authorEmail?>?subject=Comment on Question code VRE<?=$vidId?>"><?=$authorEmail?></a></p>
						...
						<div class="signup_submit" style="padding-left: 0;">
							...
							<a href="./MP_LECT_SNA_videoRevValidateEdit.php?id_act=<?=$vidId?>&<?=$queryStr?>"><button type="button" class="edit" style="width: 100px;margin-left: 5px;padding: 5px;" />EDIT</button></a>
