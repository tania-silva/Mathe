...
?>
	...
	<script src='https://cdnjs.cloudflare.com/ajax/libs/mathjax/2.7.5/latest.js?config=TeX-MML-AM_CHTML' async></script>
					...
					<p class="rsvPage_Title">Manage Your Video Lessons</p>
					...
					<form method="post" action="./MP_LECT_SNA_videoLesManage.php" style="padding: 10px;font-size: 0.9em;background-color: #e1f7ff;border: solid 1px #00AEEF;border-radius: 5px;">
						...
						<div style="float: right;width: 100px;margin-right: 10px;">
							<a href="./MP_LECT_SNA_videoLesManage.php"><button type="button" class="abort" />All</button></a>
					...
					<?php if ($totale>0) {?>
						<table class="table table-hover">
							...
							while ($row=mysqli_fetch_array($resultP)) { 
								...
								$lnk1="./MP_LECT_SNA_videoLesEdit.php?id_act=".$vidId."&".$queryStr;
								$lnk3="./MP_LECT_SNA_videoLesDelete.php?id_act=".$vidId."&".$queryStr;
					...
					<?php } else {?>	
						<p style="padding: 25px 0 0 0;font-size: 1.5em;font-weight: 400;color: #090;text-align: center;">No one video lessons</p>
					<?php }?>
