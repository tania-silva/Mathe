...
if ($from=="toggle") $destPage="MP_LECT_SNA_TchMatApprovedList";
else $destPage="MP_LECT_SNA_TchMatValidateList";
...
?>
	...
	<script src='https://cdnjs.cloudflare.com/ajax/libs/mathjax/2.7.5/latest.js?config=TeX-MML-AM_CHTML' async></script>
					...
					<form method="post" action="./MP_LECT_SNA_TchMatValidateResponse.php?act=reg&id_act=<?=$vidId?>&<?=$queryStr?>" enctype="multipart/form-data" style="display: block;margin-top: 5px;padding: 20px 0 20px 50px;border: solid 1px #00aeef;border-radius: 10px;">
						...
						<div class="signup_field_ext">
							<div style="width: 625px;padding: 10px 0 10px 10px;border: dotted 1px #666;border-radius: 5px;">
								<div style="float: left;width: 300px;">
									<p><span style="font-weight: 400;color: #666;">Code:</span> TCM<?=$vidId?></p>
								...
								<div style="float: right;width: 300px;margin-right: 10px;border: solid 1px #ccc;border-radius: 5px;">
									...
									<div style="padding: 5px;">
										...
										<p><a href="mailto:<?=$authorEmail?>?subject=Comment on Teaching Material code TCM<?=$vidId?>"><?=$authorEmail?></a></p>
						...
						<div class="signup_field_ext">
							<label style="font-weight: 400;color: #090;">Title of the teaching material</label>
						...
						<div class="signup_field_ext">
							<label style="font-weight: 400;color: #090;">Author of the teaching material</label>
							<div style="width: 625px;padding: 10px 0 10px 10px;border: dotted 1px #090;border-radius: 5px;">
								<?=$videoAuthor?>
							</div>
						</div>
						...
						<div class="signup_field_ext">
							<label style="font-weight: 400;color: #090;">* Type of Product</label>
							<div style="width: 625px;padding: 10px 0 10px 10px;border: dotted 1px #090;border-radius: 5px;">
								<?php
								...
								while ($row=mysqli_fetch_array($result)) {
									...
									if (strrpos($videoType,"_".$id_key."_")) {
										?>
											<em style="float: left;width: 200px;padding: 3px 0 0 0;font-weight: normal;">- <?=$nome?></em>
										<?php
									}
								}
								?>
						...
						<div class="signup_field_ext">
							<label style="font-weight: 400;color: #090;">Upload</label>
							<?php if ($fileName) {?>
							...
							<?php } else echo "<div style=\"margin: 10px 0 0 10px;font-size: 0.9em;color: #000;\">No attached files</div>";?>
						</div>

						<div class="signup_field_ext">
							<label style="font-weight: 400;color: #090;">Link</label>
							<div style="width: 625px;padding: 10px 0 10px 10px;border: dotted 1px #090;border-radius: 5px;">
						...
						<div class="signup_submit" style="padding-left: 0;">
							...
							<a href="./MP_LECT_SNA_TchMatValidateEdit.php?id_act=<?=$vidId?>&<?=$queryStr?>"><button type="button" class="edit" style="width: 100px;margin-left: 5px;padding: 5px;" />EDIT</button></a>
