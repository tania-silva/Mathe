...
?>
	...
	<script src='https://cdnjs.cloudflare.com/ajax/libs/mathjax/2.7.5/latest.js?config=TeX-MML-AM_CHTML' async></script>
					...
					<p class="rsvPage_Title">All Validated Teaching Materials</p>
					...
					<div style="margin: 25px 0 5px 5px;">
						<p style="float: right;width: 300px;padding: 0 10px 0 0;text-align: right;">Found <?=$totale?> Teaching Material(s)</p>
						<!-- <p style="float: right;width: 300px;padding: 0 0 0 0;text-align: right;"><a href="./MP_LECT_SNA_TchMatAdd.php" class="bt_css1">Insert new Question</a></p> -->
						<div class="clear"></div>
					</div>
					<form method="post" action="./MP_LECT_SNA_TchMatApprovedList.php" style="padding: 10px;font-size: 0.9em;background-color: #e1f7ff;border: solid 1px #00AEEF;border-radius: 5px;">
						...
						<div style="float: right;width: 50px;margin-right: 10px;">
							<!-- <a href="./MP_LECT_SNA_TchMatApprovedList.php"><button type="button" class="abort" />All</button></a> -->
					...
					<?php if ($totale>0) {?>
						<table class="table table-hover">
							...
							while ($row=mysqli_fetch_array($resultP)) { 
								...
								$lnk3="./MP_LECT_SNA_TchMatValidateResponse.php?id_act=".$vidId."&".$queryStr."&from=toggle";
