		...
		<div id="cnt1">
			<div id="corpo"><div id="rsv">
				...
				<div id="rsv_crp">
					...
					<div class="txt">
						Here you can modify information about counsellor of this school.<br />
						If you want to <strong>add a counsellor</strong> in this school <a href="./rsv_schools_new2.php?id_sch=<?=$id_sch?>&opz=1">click here</a>
						<br /><br />
						If you want to <strong>see all the school</strong> yet uploaded <a href="./rsv_schools.php">click here</a><br />
						If you want to <strong>manage the teachers</strong> of this school <a href="./rsv_schools_teachers.php?id_sch=<?=$id_sch?>">click here</a>
					</div>
					...
					<table class="for1" style="margin-top: 25px;">
						<thead>
							<tr>
								...
								<td class="tdtit">Counsellor name</td>
...
//							$sql = "SELECT * FROM members_school_counsellor
//							WHERE id_sch=".$id_sch."
//							ORDER BY couns_name";

							$sql = "
							SELECT * FROM members_school_counsellor as o
							...
							while ($row=mysqli_fetch_array($result)) {
								$lnk1="./rsv_schools_counsellor_mod.php?id_sch=".$row["id_sch"]."&id_tch=".$row["id_tch"];
								//$lnk1="./rsv_schools_mod.php?id_sch=".$row["id_sch"];
								$lnk3="./rsv_schools_counsellor_del.php?id_sch=".$row["id_sch"]."&id_tch=".$row["id_tch"];
								...
								$counsellor_name=Pulisci_READ($row["couns_name"]);
								...
								<tr>
									...
									<td><?=$school_name?></td>
									<td style="text-align: right;"><?php if ($par_permit=="on") {  ?><a href="<?=$lnk3?>"><img src="./impianto/img/delete.png" width="24" height="15" alt="Delete this counsellor" /></a> <?php }?><?php if ($par_permit=="on") {  ?><a href="<?=$lnk1?>"><img src="./impianto/img/edit.png" width="27" height="15" alt="Edit this counsellor" /></a><?php }?></td>
								</tr>
								<?
							}
							?>
