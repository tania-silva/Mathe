			...
			<div class="col-1"></div>
                        ...
                        <div class="single-content">
							...
							<h2 class="single-title">
								<?php if ($_SESSION["guest"]) {?>
									Please select a math topic, subtopic and keyword to access the available video lessons.
								<?php } else {?>
									A collection of reviewed video lessons on selected Math topics.
								<?php }?>
							</h2>
							...
							<!-- <div class="info">
								<div class="entry">
									<span class="categories">
										<i class="fas fa-tag"></i>Video Collection
									</span>
								</div>
							</div> -->
				...
				<div id="page_crp">
					<div class="txt">
						...
						<?//if ($usrId==26 OR $usrId==37 OR $usrId==38 OR $usrId==64) {?>
						<?php if ($_SESSION["guest"]) {?>

							<form method="post" action="./MALI_VC.php" style="padding: 10px;font-size: 0.9em;background-color: #e1f7ff;border: solid 1px #00AEEF;border-radius: 5px;">
								...
								<!-- <a href="./MALI_VC.php"><button type="button" class="abort" style="margin-left: 600px;" />All</button></a>
								<input type="submit" value="find videos" class="filter" id="filter" style="display: none;margin: 20px 0 0 300px;padding: 5px 15px;" /> -->
							...
							if ($getTopic OR $getSubTopic) {
								...
								if ($totale>0) {?>
									<table class="table table-hover">
										<thead>
											<tr>
												<th class="tdtit"><img src="./wiztr.gif" width="100" height="1" /></th>
										...
										while ($row=mysqli_fetch_array($resultP)) { 
											...
											<tr>
												...
												<td style="font-size: 0.9em;line-height: 1.0em;">
													...
													<div style="padding-top: 5px;font-size: 0.8em;line-height: 1.3em;"><a href="<?=$videoLinkTr?>" target="_blank"><?=$videoLinkTr?></a></div>
												</td>
											</tr>
											<?php
											$count+=1;
								...
								<?php } else {?>	
									<p style="padding: 25px 0 0 0;font-size: 1.5em;font-weight: 400;color: #090;text-align: center;">No videos available</p>
								<?php }?>
						<?php }?>
					...
					<?php } else {?>
						...
						<div style="padding: 15px 0 35px 0;font-size: 1.2em;text-align: center;">
							<p>Here you can find a collection of videos about several math topics.</p>
							<p style>To view the videos you need to login:</p>
						...
						<hr />
							...
							<hr />
						<p style="padding-top: 15px;font-size: 1.2em;">In this section you can find a collection of videos  on the following math topics/subtopics:</p>
						<div>
							<ul>
							<?php
							$sql = "
