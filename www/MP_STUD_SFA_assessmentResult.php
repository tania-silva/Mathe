...
?>
	...
	<script src='https://cdnjs.cloudflare.com/ajax/libs/mathjax/2.7.5/latest.js?config=TeX-MML-AM_CHTML' async></script>
					...
					<p class="rsvPage_Title">Result of Final Assessment</p>
					...
					<div class="signup_submit" style="padding: 0 0 10px 0;">
						...
						<p style="float: right;width: 113px;padding: 0 10px 0 0;"><a href="./MP_STUD_SFA_assessmentManage.php"><button type="button" class="abort" style="width: 100px;padding: 5px;" />Exit</button></a></p>
						<div class="clear"></div>
					</div>
					...
					<div style="padding: 30px 0 0 20px;font-size: 1.2em;text-align: center;">
						<p style="font-size: 1.5em;">Your score: <strong><?=$totPoint?></strong></p>
