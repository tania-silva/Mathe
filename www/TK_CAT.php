            ...
            <div class="container">
                <div class="heading-page-content">
                    <div class="au-page-title">
                        <h1>Competence Assessment Tools</h1>
                    </div>
                    <nav aria-label="breadcrumb">
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.php">Home</a></li>
			    <li class="breadcrumb-item"><a href="index.php">Toolkit</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Competence Assessment Tools</li>
                        </ul>
                    </nav>
                </div>
            </div>
                        ...
                        <div class="single-content">
                            <article class="item">
                                <h1 class="single-title">
                                    A collection of competence assessment tools for science teachers to identify the students' gaps of Digital competences.
                                </h1>
				
                                <div class="info">
                                    <div class="entry">
                                        <span class="categories">
                                            <i class="fas fa-tag"></i>Toolkit
                                        </span>
                                    </div>
                                </div>
