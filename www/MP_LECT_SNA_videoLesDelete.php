...
?>
	...
	<script src='https://cdnjs.cloudflare.com/ajax/libs/mathjax/2.7.5/latest.js?config=TeX-MML-AM_CHTML' async></script>
					...
					<p class="rsvPage_Title">Delete Video Lesson</p>
					<p class="rsvPage_Title1">Student Need Assessment</p>
						...
						<div class="el_msg" style="margin-top: 10px;padding: 10px;border: solid 1px #00AEEF;border-radius: 5px;">
							<p class="p01" style="margin: 0;padding: 0;text-align: center;">Do you want to delete this Video Lesson?</p>
							...
							<div class="signup_submit" style="padding-left: 70px;">
								<a href="./MP_LECT_SNA_videoLesManage.php?<?=$queryStr?>"><button type="button" class="abort" style="margin-left: 30px;" />Abort</button></a>
								<a href="./MP_LECT_SNA_videoLesDelete.php?id_act=<?=$act_id?>&<?=$queryStr?>&act=delete"><button type="button" class="proceed" style="margin-left: 20px;" />Proceed</button></a>
							</div>
						</div>
