...
?>
	...
	<script src='https://cdnjs.cloudflare.com/ajax/libs/mathjax/2.7.5/latest.js?config=TeX-MML-AM_CHTML' async></script>
					...
					<form method="post" action="./MP_LECT_SNA_TchMatAdd3.php?act=reg&idVideo=<?=$vidId?>&from=<?=$fromPage?>" enctype="multipart/form-data" style="display: block;margin-top: 5px;padding: 20px 0 20px 15px;border: solid 1px #00aeef;border-radius: 10px;">
...
//								$resultP=mysqli_query($conn,$sqlP);
						...
						<!-- <div class="signup_submit" style="padding-left: 70px;">
							<a href="./MP_LECT_SNA_TchMatManage.php"><button type="button" class="abort" />Abort</button></a>
