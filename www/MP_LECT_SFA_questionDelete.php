...
if ($act=="delete" AND $act_id AND $usrId) {
	...
	$pict="./data/mathePlatform/SFA/attach/{$act_id}.{$fileExt}";
					...
					<p class="rsvPage_Title1">Student Final Assessment</p>
						...
						<div class="el_msg" style="margin-top: 10px;padding: 10px;border: solid 1px #00AEEF;border-radius: 5px;">
							...
							<div class="signup_submit" style="padding-left: 70px;">
								<a href="./MP_LECT_SFA_questionManage.php?<?=$queryStr?>"><button type="button" class="abort" style="margin-left: 30px;" />Abort</button></a>
								<a href="./MP_LECT_SFA_questionDelete.php?id_act=<?=$act_id?>&<?=$queryStr?>&act=delete"><button type="button" class="proceed" style="margin-left: 20px;" />Proceed</button></a>
							</div>
						</div>
