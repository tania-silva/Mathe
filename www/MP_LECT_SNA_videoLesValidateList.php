...
?>
	...
	<script src='https://cdnjs.cloudflare.com/ajax/libs/mathjax/2.7.5/latest.js?config=TeX-MML-AM_CHTML' async></script>
					...
					<form method="post" action="./MP_LECT_SNA_videoLesValidateList.php" style="padding: 10px;background-color: #e1f7ff;border: solid 1px #00AEEF;border-radius: 5px;">
						...
						<div style="float: right;width: 120px;margin-right: 0px;">
							<a href="./MP_LECT_SNA_videoLesValidateList.php"><button type="button" class="abort" style="margin-left: 0px;" />All</button></a>
