...
//		if ($check->isOk()) {
		...
		$redirectUrl="./MP_LECT_SNA_TchMatManage.php?".$queryStr;

	} else $redirectUrl="./MP_LECT_SNA_TchMatEdit.php?msg=KO&".$queryStr;
...
//		  });
					...
					<p class="rsvPage_Title">Edit Teaching Material</p>
					...
					<form method="post" action="./MP_LECT_SNA_TchMatEdit.php?act=reg&id_act=<?=$vidId?>&<?=$queryStr?>" enctype="multipart/form-data" style="display: block;margin-top: 5px;padding: 20px 0 20px 50px;border: solid 1px #00aeef;border-radius: 10px;">
						...
						<div class="signup_field_ext">
							...
							<textarea name="videoAuthor" id="videoAuthor" style="height: 50px;" required /><?=$videoAuthor?></textarea>
						</div>
						...
						<div class="signup_field_ext">
							...
							<?php 
								$fileUploadExt="./data/mathePlatform/SNA/tchMaterials/".$vidId.".".$fileExt;
							?>
							<?php if (file_exists($fileUploadExt) AND $fileName) {?>
						...
						<div class="signup_field_ext">
							...
							<textarea name="videoLink" id="videoLink" style="height: 50px;" /><?=$videoLink?></textarea>
						</div>
						...
						<div class="signup_submit" style="width: auto;padding-left: 30px;">
							<a href="./MP_LECT_SNA_TchMatManage.php?<?=$queryStr?>"><button type="button" class="abort" style="width: 100px;font-size: 1.3em;padding: 5px 20px;" />Exit</button></a>
