...
?>
	...
	<script src='https://cdnjs.cloudflare.com/ajax/libs/mathjax/2.7.5/latest.js?config=TeX-MML-AM_CHTML' async></script>
					...
					<form method="post" action="./MP_LECT_SFA_questionApprovedList.php" style="padding: 10px;font-size: 0.9em;background-color: #e1f7ff;border: solid 1px #00AEEF;border-radius: 5px;">
						...
						<div style="float: right;width: 50px;margin-right: 10px;">
							<!-- <a href="./MP_LECT_SFA_questionApprovedList.php"><button type="button" class="abort" />All</button></a> -->
					...
					<?php if ($totale>0) {?>
						<table class="table table-hover">
							...
							while ($row=mysqli_fetch_array($resultP)) { 
								...
								$lnk3="./MP_LECT_SFA_questionValidateResponse.php?id_act=".$qstId."&".$queryStr."&from=toggle";
