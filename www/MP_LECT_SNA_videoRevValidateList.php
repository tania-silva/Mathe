...
//								}
//								//if ($strTopID AND !$strSubtop) $where.="(p.topic=$strTopID AND p.subtopic=0) OR ";
//								//if ($strSubtop) $where.="(p.topic=$strSubtop_ar[0] AND p.subtopic=$strSubtop_ar[1]) OR ";
//								if ($strTopID AND !$strSubtop) $where.="LOCATE('_".$strTopID."_', topic)>0 OR ";
//								if ($strSubtop_ar[1]) $where.="LOCATE('_".$strSubtop_ar[1]."_', p.subtopic)>0 OR ";
//							}
...
//					}
					...
					<form method="post" action="./MP_LECT_SNA_videoRevValidateList.php" style="padding: 10px;background-color: #e1f7ff;border: solid 1px #00AEEF;border-radius: 5px;">
						...
						<div style="float: right;width: 120px;margin-right: 0px;">
							<a href="./MP_LECT_SNA_videoRevValidateList.php"><button type="button" class="abort" style="margin-left: 0px;" />All</button></a>
