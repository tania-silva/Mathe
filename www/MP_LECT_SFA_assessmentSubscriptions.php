	...
	text-shadow: rgba(0,0,0,.4) 0 1px 0;
					...
					<table class="table table-hover">
						<thead>
							<tr>
								<th class="tdtit"></th>
								<th class="tdtit" style="width: 100%;">Student</th>
								<th class="tdtit"></th>
							</tr>
						</thead>
						<tbody>
							...
							while ($row=mysqli_fetch_array($result)) { 
								...
								if ($RqstStatus==1) $RqstStatusTr="<button type=\"button\" class=\"verde\" style=\"width: 80px;\" />accepted</button>"; // Il professore ha accettato la richiesta
								elseif ($RqstStatus==2) $RqstStatusTr="<button type=\"button\" class=\"grigio\" style=\"width: 80px;\" />rejected</button>"; // Il professore NON ha accettato la richiesta
								else $RqstStatusTr="<button type=\"button\" class=\"rosso\" style=\"width: 80px;\" />waiting</button>"; // Il professore non ha ancora valutato la richiesta


								$lnk1="xxx.php?assId=".$assId;
								$lnk2="xxx.php?assId=".$assId;
								$lnk3="xxx.php?assId=".$assId;

								$param=$assId."|".$studId;
								?>
								<tr>
									<td style="font-size: 0.9em;text-align: center;">
										<div id="blkRqst<?=$rqstId?>" onclick="studRqstStatus('blkRqst<?=$rqstId?>','<?=$param?>');"><?=$RqstStatusTr?></div>
									</td>
