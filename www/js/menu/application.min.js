...
$(".mobile-btn").click(function() {
    $(".product-iframe").addClass("iframe-mobile").removeClass("iframe-tablet");
})

$(".tablet-btn").click(function() {
    $(".product-iframe").addClass("iframe-tablet").removeClass("iframe-mobile");
})

$(".desktop-btn").click(function() {
    $(".product-iframe").removeClass("iframe-mobile iframe-tablet");
})

$(".close-btn").click(function() {
    window.location.href = $(".product-iframe").attr("src");
})

$('select').selectric();

var selectedExample;
$('#select-examples').selectric().on('change', function(){
	selectedExample = $('#select-examples').val()
	$(".product-iframe").attr("src", "pages/" + selectedExample + ".html");
});
