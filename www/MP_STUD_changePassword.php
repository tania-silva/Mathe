...
if ($_GET["act"]=="reg") {
	...
	// Redirect
	$strpas11="./MP_STUD_changePassword.php?userId={$userId}&msg={$msg}";
...
?>
					...
					<form method="post" action="./MP_STUD_changePassword.php?act=reg" enctype="multipart/form-data" style="display: block;margin-top: 5px;padding: 20px 0 20px 50px;border: solid 1px #00aeef;border-radius: 10px;">
