...
?>
	...
	<script src='https://cdnjs.cloudflare.com/ajax/libs/mathjax/2.7.5/latest.js?config=TeX-MML-AM_CHTML' async></script>
					...
					<form method="post" action="./MP_LECT_SNA_questionManage.php" style="padding: 10px;font-size: 0.9em;background-color: #e1f7ff;border: solid 1px #00AEEF;border-radius: 5px;">
					...
					<?php if ($totale>0) {?>
						<!-- <table class="for1" style="margin-top: 5px;"> -->
						<table class="table table-hover">
							...
							while ($row=mysqli_fetch_array($resultP)) { 
								...
								$lnk1="./MP_LECT_SNA_questionEdit.php?id_act=".$qstId."&".$queryStr;
								$lnk3="./MP_LECT_SNA_questionDelete.php?id_act=".$qstId."&".$queryStr;
