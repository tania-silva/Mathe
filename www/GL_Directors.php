            ...
            <div class="container">
                <div class="heading-page-content">
                    <div class="au-page-title">
                        <h1>School directors and Policy Makers</h1>
                    </div>
                    <nav aria-label="breadcrumb">
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.php">Home</a></li>
			    <li class="breadcrumb-item"><a href="index.php">Guidelines</a></li>
                            <li class="breadcrumb-item active" aria-current="page">School directors and Policy Makers</li>
                        </ul>
                    </nav>
                </div>
            </div>
                                ...
                                <div class="info">
                                    <div class="entry">
                                        <span class="categories">
                                            <i class="fas fa-tag"></i>Guidelines
                                        </span>
                                    </div>
                                </div>
