...
if ($_GET["act"]=="reg" AND $usrId) {
	...
	if ($checkStatus) {
		...
		$sql = "
			INSERT INTO `platform__SNA__VID_lessons` 
...
//			//$path=ereg_replace("MP_LECT_SNA_videoLesAdd.php","",$_SERVER["PATH_TRANSLATED"]);
...
//		}
		...
		$redirectUrl="./MP_LECT_SNA_videoLesAdd1.php?idVideo=".$videoId;

	} else $redirectUrl="./MP_LECT_SNA_videoLesAdd.php?msg=KO";
...
//		  s = s.split('\'').join('&#92;');
		...
		//doPreview('init');
					...
					<p class="rsvPage_Title">Insert New Video Lesson</p>
					...
					<form method="post" action="./MP_LECT_SNA_videoLesAdd.php?act=reg" enctype="multipart/form-data" style="display: block;margin-top: 5px;padding: 20px 0 20px 50px;border: solid 1px #00aeef;border-radius: 10px;">
